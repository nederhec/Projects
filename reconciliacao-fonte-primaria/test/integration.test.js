 ...
 * SheetJS de verdade e roda engine.js sobre ela — diferente dos testes de
 ...
 *
 * Requer a devDependency `xlsx` (npm install).
 */
...
const wb = XLSX.readFile(fixturePath, { cellFormula: true, cellDates: true });
